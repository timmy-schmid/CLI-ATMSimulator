...
public class Card {
  ...
  /**
   * Decide if the card is expired or not by comparing the expiration date of the card
   * and current time.
  ...
  /**
   * Decide if the card can be used after the start date by comparing the start date of the card
  ...
  public void getCardDetails(){
    ...
    System.out.printf("Card number [%d] has $%.2f amount remaining and expires on: "
        + ft.format(this.expirationDate) + ".\n", cardNumber, getBalance());
  }
}
